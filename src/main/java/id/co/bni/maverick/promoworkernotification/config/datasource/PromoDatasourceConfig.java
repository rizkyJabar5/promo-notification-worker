...
@EnableJpaRepositories(
        basePackages = "id.co.bni.maverick.promoworkernotification.additional.repository.promo",
...
public class PromoDatasourceConfig {
    ...
    LocalContainerEntityManagerFactoryBean promoEntityManager(@Qualifier("promoDataSource") DataSource dataSource,
        ...
        return builder
                ...
                .packages("id.co.bni.maverick.promoworkernotification.additional.entity.promo")
                .build();
    }
