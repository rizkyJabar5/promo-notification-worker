package id.co.bni.surrounding.promo.workernotification.config.event;
...
@Configuration
public class PromoProducerConfig {
    ...
    private HashMap<String, Object> configProps() {
        ...
        if (Boolean.TRUE.equals(this.kafkaProperties.producer().jaas())) {
